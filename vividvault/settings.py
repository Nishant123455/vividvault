"""
Django settings for vividvault project.
...
WSGI_APPLICATION = 'vividvault.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'vividvault/static'),
 ]
...
DEFAULT_FILE_STORAGE = 'vividvault.media_storages.MediaStorage'
"""
